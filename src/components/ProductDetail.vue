<template>
  <v-dialog v-model="showDialog" max-width="800">
    <v-card>
      ...
      <v-img v-else src="https://picsum.photos/400" height="400px" cover></v-img>
      ...
      <v-card-text>
        ...
        <div class="d-flex align-center mb-4">
          ...
          <div>
            ...
            <div class="d-flex align-center">
              <v-rating :model-value="product.user.rating" color="amber" density="compact" half-increments readonly
                size="small"></v-rating>
        ...
        <v-list>
          ...
          <v-list-item>
            ...
            <v-list-item-subtitle>{{ product.width }} x {{ product.height }} x
              {{ product.depth }}</v-list-item-subtitle>
          </v-list-item>
          ...
          <v-list-item>
            <v-list-item-title><strong>Marcas:</strong></v-list-item-title>
            <v-list-item-subtitle>
              <span v-if="product.brands.length">
